...
public class Login extends Activity implements OnClickListener {
    ...
    private static final String LOGIN_URL = "http://186.137.170.157:2122/nicolas/logintecnicosV1/logintec.php";
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    edit.commit();
                    Intent i = new Intent(Login.this, Pedido.class);

                    //enviar datos de una actividad a otra
                    i.putExtra("idtecnico", json.getString(TAG_TECNICO));
                    i.putExtra("nombretec", json.getString(TAG_NOMBRE));
                    i.putExtra("apellidotec", json.getString(TAG_APELLIDO));

                    finish();
                    startActivity(i);
                    //return json.getString(TAG_MESSAGE);
                    //return json.getString(TAG_TECNICO);
                } else {
